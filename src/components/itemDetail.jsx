        ...
        <div className='detailPage'>
            <Container>
                <Row>
                    <Col>
                        <Row>
                            <Image style={{ width: "300px", border: '2px solid black' }} src={props.item.image} rounded ></Image>
                        </Row>
                        <Row>
                            <Image style={{ width: "100px", border: '2px solid black' }} src={props.item.image} rounded ></Image>
                            <Image style={{ width: "100px", border: '2px solid black' }} src={props.item.image} rounded ></Image>
                            <Image style={{ width: "100px", border: '2px solid black' }} src={props.item.image} rounded ></Image>
                        </Row>
                    </Col>
